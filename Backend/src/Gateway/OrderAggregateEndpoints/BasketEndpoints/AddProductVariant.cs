...
public class AddProductVariant : EndpointBaseAsync
    .WithRequest<AddProductVariantRequest>
    .WithActionResult<BaseBasketResponse<BasketDto>>
{
    ...
    public AddProductVariant(IRepository<Basket> basketRepository, IRepository<Product> productRepository)
    {
        _basketRepository = basketRepository;
        _productRepository = productRepository;
    }

    [HttpPost(BaseRequest.BasketRoute + "/Customers/{Id}")]
    [SwaggerOperation(
        Summary = "Add ProductVariant to Basket",
        Description = "Add ProductVariant to Basket",
        Tags = new[] { "Baskets" })
    ]
    public override async Task<ActionResult<BaseBasketResponse<BasketDto>>> HandleAsync([FromRoute] AddProductVariantRequest request,
        CancellationToken cancellationToken = new CancellationToken())
    {
        ...
        try
        {
            basket.AddProductVariant(productVariants);
