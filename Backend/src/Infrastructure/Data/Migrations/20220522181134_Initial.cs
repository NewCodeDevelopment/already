    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    BrandsId = table.Column<Guid>(type: "uuid", nullable: false),
                    ShopsId = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BrandShop", x => new { x.BrandsId, x.ShopsId });
                    table.ForeignKey(
                        name: "FK_BrandShop_Brands_BrandsId",
                        column: x => x.BrandsId,
                        principalTable: "Brands",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BrandShop_Shops_ShopsId",
                        column: x => x.ShopsId,
            ...
            migrationBuilder.CreateTable(
                name: "ProductOptionValueProductVariant",
                columns: table => new
                {
                    ProductOptionValuesId = table.Column<Guid>(type: "uuid", nullable: false),
                    ProductVariantsId = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductOptionValueProductVariant", x => new { x.ProductOptionValuesId, x.ProductVariantsId });
                    table.ForeignKey(
                        name: "FK_ProductOptionValueProductVariant_ProductOptionValues_Produc~",
                        column: x => x.ProductOptionValuesId,
                        principalTable: "ProductOptionValues",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductOptionValueProductVariant_ProductVariants_ProductVar~",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductOptionValueProductVariant_ProductVariantsId",
                table: "ProductOptionValueProductVariant",
